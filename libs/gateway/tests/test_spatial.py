...
from mapa.gateway.integration.integration_model import Integration, CreateIntegration, SoapConnection, SpatialConnection, UpdateAllIntegration, UpdateIntegration
...
@pytest.mark.asyncio
async def test_create_spatial_api(fixture: GatewayFixture):
    """Service"""
