...
class ApplicationFixture(BaseFixture):
    ...
    def __init__(self) -> None:
        ...
        self.config = {
            "api_host": "http://0.0.0.0:33103",
            "app_host": "http://0.0.0.0:33003",
            "secret": "top_secret"
        }
    ...
    async def create_test_data(self) -> bool:
        ...
        if initialized:
            await self.grant_permissions(async_db, "mapa_test", "mapa", "application")
...
@pytest.fixture(scope="session")
async def fixture(event_loop) -> ApplicationFixture:  # type: ignore
    """Oturum bazlı fikstür parametresi_
    """
    yield ApplicationFixture()
